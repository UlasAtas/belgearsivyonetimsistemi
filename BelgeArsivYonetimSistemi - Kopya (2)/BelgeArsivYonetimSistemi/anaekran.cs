    ...
    public partial class anaekran : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                new Evrakservice().evrakGuncelle(int.Parse(dataGridView1.CurrentRow.Cells[0].Value.ToString()), textBox2.Text, textBox1.Text, textBox3.Text);
        ...
        private void textBox5_TextChanged(object sender, EventArgs e)
        {
            ...
            MySqlDataAdapter da = new MySqlDataAdapter("select * from evraklar where id like '" + textBox5.Text + "%' or evrakaciklama like '" + textBox5.Text + "%' or evraktipi like '" + textBox5.Text + "%' or evrakyeri like'" + textBox5.Text + "%' or kayittarihi like '%"+ textBox5.Text +"%' ", (new dbbaglanti()).baglantiGetir());
            DataTable table = new DataTable();
            da.Fill(table);
            dataGridView1.DataSource= table;
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                new Emanetciservice().emanetciKaydet(textBox6.Text, textBox7.Text, textBox8.Text,textBox9.Text);
                MessageBox.Show("kayıt başarılı");
                listele2();
            }
        }
        ...
        {
            MySqlDataAdapter da = new MySqlDataAdapter("select * from emanetci where id like '" + textBox4.Text + "%' or ad like '" + textBox4.Text + "%' or soyad like '" + textBox4.Text + "%' or iletisim like'" + textBox4.Text + "%' or evrakid like '"+ textBox4.Text+"' or emanettarihi like '%"+ textBox4.Text+"%' ", (new dbbaglanti()).baglantiGetir());
            DataTable table = new DataTable();
            da.Fill(table);
            dataGridView2.DataSource = table;
        }
        ...
        {
            new Emanetciservice().emanetciSil(int.Parse(dataGridView2.CurrentRow.Cells[0].Value.ToString()), textBox6.Text, textBox7.Text, textBox8.Text,textBox9.Text);
            MessageBox.Show("silme başarılı");
            listele2();
        }
        ...
        private void button6_Click_1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                new Emanetciservice().emanetGuncelle(int.Parse(dataGridView2.CurrentRow.Cells[0].Value.ToString()), textBox6.Text, textBox7.Text, textBox8.Text,textBox9.Text);
                MessageBox.Show("güncelleme başarılı");
                listele2();
            }
        }
